...
`;permrole`, `;pr`  |  Sets a role which can change permissions. Or supply no parameters to find out the current one. Default one is 'merchant'.
...
`>rps`  |  Play a game of rocket paperclip scissors with Merchantbot. |  >rps scissors
